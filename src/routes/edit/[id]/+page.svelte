<script>
    ...
    // @ts-nocheck
      ...
      const allgroup = [];
      let qushtions = [].concat(data.expand.mcq_via_paper,data.expand.msq_via_paper,data.expand.nat_via_paper,data.expand.short_answer_via_paper)
      console.log(qushtions)
     // @ts-ignore
       $: cards = writable([ {
          id: 1,
          content: {
