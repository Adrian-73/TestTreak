<script>
	...
	$:paper_url = '/paper/';
	$:if (url.includes('/group/',0)){
	
		paper_url = '/paper?grp=' + url.split('/group/')[1];
	}
	export let data;
</script>

<div class="min-h-full">
	<nav class="navbar z-20  bg-base-300 border-b">
		<div class="flex-1">
			<a href="/" class="btn btn-ghost normal-case text-xl"><img src={logo} alt="logo" 
			class="w-18 h-10" />
			</a>
		</div>
		...
		<div class="flex-none">
			...
			{:else}{#if data.user.type == "examiner"}
					...
					<div class="dropdown dropdown-end mr-4">
						<a href={paper_url} class="btn btn-accent btn-outline">Add paper</a>
					</div>
			{/if}
				<div class="dropdown dropdown-end z-20">
					...
					<label tabindex="0" class="btn btn-ghost btn-circle avatar">
						<div class="w-10 rounded-full">
							<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMcL4AEbLTIBKLFW09-AXSjpXEPXAVBHF5Qw&s" alt="User avatar" />
						</div>
					</label>
					<!-- svelte-ignore a11y-no-noninteractive-tabindex -->
					<ul
					...
					>
						<li>
							<a href="/paper" class="justify-between">My Projects</a>
						</li>
...
<footer class="footer footer-center p-10 bg-primary text-primary-content">
    <div>
      ...
      <p class="font-bold">Test Trek Ltd. <br>Providing reliable online exams since 2023</p>
